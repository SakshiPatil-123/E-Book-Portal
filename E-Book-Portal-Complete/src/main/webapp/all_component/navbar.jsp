...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<form class="form-inline my-2 my-lg-0">
			...
			<%-- 	<a href="${pageContext.request.contextPath}/helpline.jsp"
				class="btn btn-light my-2 my-sm-0 ml-1"> <i
				class="fa-solid fa-phone"></i> Contact Us
			</a> --%>

			<a href="helpline.jsp" class="btn btn-light my-2 my-sm-0 ml-1"> <i
				class="fa-solid fa-phone"></i> Contact Us
			</a>
		</form>
	</div>
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1"
	role="dialog" aria-labelledby="logoutModalTitle" aria-hidden="true">

	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">

			<div class="modal-header">
				<h5 class="modal-title" id="logoutModalTitle">Logout Confirmation</h5>
